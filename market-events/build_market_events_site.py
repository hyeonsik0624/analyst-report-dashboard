...
<style>
:root{{--bg:#0a0f1e;--panel:#111a33;--line:#23376e;--line2:#1a2c5b;--text:#ecf2ff;--muted:#9fb1df;--chip:#1c2f63;--accent:#74a2ff}}
body{{margin:0;background:radial-gradient(1200px 600px at 80% -20%,#1a2c5a55,transparent),var(--bg);color:var(--text);font-family:-apple-system,BlinkMacSystemFont,'Apple SD Gothic Neo',sans-serif}}
.wrap{{max-width:920px;margin:0 auto;padding:20px}}
.card{{background:var(--panel);border:1px solid var(--line2);border-radius:16px;padding:14px 16px;margin:10px 0;box-shadow:0 8px 28px rgba(0,0,0,.22)}}
h1{{margin:.1rem 0 .35rem 0;font-size:1.55rem}} h2{{margin:.1rem 0 .7rem 0;font-size:1.08rem}}
ul{{margin:0;padding-left:18px}} li{{margin:7px 0;line-height:1.45}}
.highlights{{list-style:none;padding-left:0;display:grid;gap:8px}}
.highlights li{{margin:0}}
.tag{{background:var(--chip);border:1px solid #3857a7;color:#cfe0ff;padding:3px 9px;border-radius:999px;font-size:.76rem;white-space:nowrap}}
.highlight-item{{display:grid;grid-template-columns:72px 1fr auto;gap:10px;align-items:center;padding:11px 12px;border:1px solid var(--line);border-radius:12px;background:#0f1730}}
.highlight-item:hover{{border-color:#3d5fb5}}
.hl-date{{font-weight:800;color:#ffd86b;font-size:.98rem}}
.hl-main{{font-weight:700;letter-spacing:-.1px}}
.hl-time{{margin-top:2px;color:var(--muted);font-size:.82rem;font-weight:500}}
.meta{{color:var(--muted);font-size:.9rem}}.warn{{border-color:#7d5f1f}}
a{{color:#d7e5ff}}
</style></head>
<body><div class='wrap'>
<h1>이번 주 핵심 일정</h1>
